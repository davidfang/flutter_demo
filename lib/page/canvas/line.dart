...
class CanvasLine extends StatefulWidget {
  static String routName = '/CanvasLine';

  @override
  _CanvasLineState createState() => new _CanvasLineState();
}

class _CanvasLineState extends State<CanvasLine> {
  @override
  void initState() {
  ...
  @override
  void didUpdateWidget(CanvasLine oldWidget) {
 ...
 */
  ...
  void _drawHart(Canvas canvas) {
    Path path4 = new Path();

    var width = 200;
    var height = 300;
    path4.moveTo(width / 2, height / 4);
    path4.cubicTo((width * 6) / 7, height / 9, (width * 12) / 13,
        (height * 2) / 5, width / 2, (height * 7) / 12);
    canvas.drawPath(path4, _paint);

    Path path5 = new Path();
    path5.moveTo(width / 2, height / 4);
    path5.cubicTo(width / 7, height / 9, width / 13, (height * 2) / 5,
        width / 2, (height * 7) / 12);
    canvas.drawPath(path5, _paint);
  }
}
