...
///Flutter 绘图部分详解
///https://www.jianshu.com/p/36fc171fde1e
///https://github.com/RCLOVETMH/RCFlutterDrawDemo/blob/master/lib/main.dart
...
class CanvasHomeDrawDemo extends StatefulWidget {
  @override
  _CanvasHomeDrawDemoState createState() => _CanvasHomeDrawDemoState();
}

class _CanvasHomeDrawDemoState extends State<CanvasHomeDrawDemo> {
  Uint8List imageMemory = new Uint8List(0);
          ...
          child: Column(
            children: <Widget>[
              ...
              imageMemory.isEmpty
                  ? TextButton(
                      ...
                      onPressed: () async {
                        ...
                        var images = await getImage(
                            'assets/images/team.jpg'); // 使用方法获取Unit8List格式的图片
                        // 绘制图片
                        ...
                        pb.addText("团队的力量🌶🌶🌶🌶🌶");
                        ParagraphConstraints pc = ui.ParagraphConstraints(
                            width: images.width.toDouble());
                  ...
                  : TextButton(child: Text('已经完成'), onPressed: () {})
            ],
          ),
        ));
  }
...
class CanvasHomeDemo extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
        child: Stack(
